...
//        request.setCoverURL("http://vod.aliyun.com/test_cover_url.jpg");
        request.setCateId(1000438632L);
        request.setTemplateGroupId("fce8481c14272f3ecf989d9fb0020213");
    ...
    public static void main(String[] argv) {
        //您的AccessKeyId
        String accessKeyId = "LTAI5tNYJbvS2CuA7qvFWyuX";
        //您的AccessKeySecret
        String accessKeySecret = "KX5zo33IkAmyrv2Y8x7ZIdir5sCP0u";
        //需要上传到VOD的本地视频文件的完整路径，需要包含文件扩展名
        String localFile = "D:\\DreamboatJAN\\慕课网-甲蛙-416 - Spring Cloud + Vue 前后端分离开发企业级在线视频课程系统\\course-online_20200414\\admin(更多IT教程 微信hahahkc)\\public\\static\\image\\小节视频\\test.mp4";
        try {
            // 初始化VOD客户端并获取上传地址和凭证
